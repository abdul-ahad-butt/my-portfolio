...
const PROJECTS = [
  ...
  },
  {
    ...
    title: 'AMK Advertising Platform & Dynamic Media Admin',
    subtitle: 'on Cloudflare D1 & R2 Storage',
    description: 'Engineered a full-stack digital advertising platform and custom Admin Suite enabling dynamic media management across agency galleries. Integrated Cloudflare D1 for metadata tracking and Cloudflare R2 for high-performance image/video asset storage and streaming. Served as Lead Architect directing a 2-developer team on production standards.',
    tags: ['Cloudflare D1', 'Cloudflare R2', 'Admin CMS', 'Lead Architecture'],
    tagIcons: [<Database size={11} />, <Cloud size={11} />, <Code2 size={11} />, <Server size={11} />],
    features: ['Dynamic Gallery CMS (Images & Videos)', 'Cloudflare D1 SQL & R2 Object Storage', 'Custom Admin Suite for portfolio updates', 'Lead Architect directing 2-dev team'],
    accent: '#84cc16',
    accentAlt: '#a3e635',
  }
];
