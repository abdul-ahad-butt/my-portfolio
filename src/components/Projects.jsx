...
const PROJECTS = [
  ...
  },
  {
    ...
    title: 'AMK Advertising Agency & Admin Suite',
    subtitle: 'Lead Architect • Custom Admin Panel',
    description: 'Architected the complete agency platform and built a custom Admin Panel to streamline administrative workflows and lead pipelines. Served as Lead Architect directing a 2-developer team, establishing best practices, and mentoring junior engineers on production-grade development workflows.',
    tags: ['Lead Architecture', 'Admin Panel', 'Team Leadership', 'Web Development'],
    tagIcons: [<Server size={11} />, <Database size={11} />, <Activity size={11} />, <Code2 size={11} />],
    features: ['Custom Admin Panel & workflow engine', 'Technical leadership for 2-developer team', 'Lead pipeline & content management', 'Architectural guidance & dev onboarding'],
    accent: '#84cc16',
    accentAlt: '#a3e635',
  }
];
